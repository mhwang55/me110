...
#include "hexapod/InstructionQueueOld.h"
...
hexapod::InstructionQueueOld standing_queue;
hexapod::InstructionOld standing_pos;
hexapod::InstructionOld current_pos;
...
{ 
  ...
  // GoalPos publisher
  ros::Publisher goal_publisher = n.advertise<hexapod::InstructionOld>("goal", 100);
